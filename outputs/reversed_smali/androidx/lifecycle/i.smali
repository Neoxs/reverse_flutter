...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/lifecycle/i;->a:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Landroidx/lifecycle/i;->b:Ljava/util/Map;
...
.method private static d(Ljava/lang/Class;)I
    ...
    sget-object v0, Landroidx/lifecycle/i;->a:Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Landroidx/lifecycle/i;->g(Ljava/lang/Class;)I

    move-result v0

    sget-object v1, Landroidx/lifecycle/i;->a:Ljava/util/Map;
...
.method static f(Ljava/lang/Object;)Landroidx/lifecycle/e;
    ...
    invoke-static {v0}, Landroidx/lifecycle/i;->d(Ljava/lang/Class;)I
    ...
    sget-object v1, Landroidx/lifecycle/i;->b:Ljava/util/Map;
    ...
    invoke-static {v0, p0}, Landroidx/lifecycle/i;->a(Ljava/lang/reflect/Constructor;Ljava/lang/Object;)Landroidx/lifecycle/c;
    ...
    invoke-static {v3, p0}, Landroidx/lifecycle/i;->a(Ljava/lang/reflect/Constructor;Ljava/lang/Object;)Landroidx/lifecycle/c;
...
.method private static g(Ljava/lang/Class;)I
    ...
    :cond_0
    invoke-static {p0}, Landroidx/lifecycle/i;->b(Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    ...
    invoke-static {v0}, Landroidx/lifecycle/i;->e(Ljava/lang/Class;)Z
    ...
    sget-object v4, Landroidx/lifecycle/i;->b:Ljava/util/Map;
    ...
    invoke-static {v6}, Landroidx/lifecycle/i;->e(Ljava/lang/Class;)Z
    ...
    :cond_5
    invoke-static {v6}, Landroidx/lifecycle/i;->d(Ljava/lang/Class;)I
    ...
    :cond_7
    sget-object v7, Landroidx/lifecycle/i;->b:Ljava/util/Map;
    ...
    sget-object v0, Landroidx/lifecycle/i;->b:Ljava/util/Map;
